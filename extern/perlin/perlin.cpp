...
//         imageBuffer[3 * k + 0] = noise[k]; // Red channel
//         imageBuffer[3 * k + 1] = noise[k]; // Green channel
//         imageBuffer[3 * k + 2] = noise[k]; // Blue channel
//     }

//     std::string outputFilename = "./noise.png";
...
void generateNoise (u32 startX, u32 startY, u32 startZ, u32 width, u32 height, f32 f, uint8_t* noise) {
